module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      dist: {
        src: [
          'app/scripts/markdown.min.js',
          'app/scripts/controllers/inline.docs.controller.js'          
        ],
        dest: '<%= dest %>/<%= basePath %>/js/inline.docs.js',
        nonull: true
      }
    },
    ...
    less: {
      dist: {
        ...
        files: {
          '<%= dest %>/<%= basePath %>/css/inline.docs.css': 'app/styles/inline.docs.less',
        }
      }
    },
